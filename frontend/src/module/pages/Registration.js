...
export default function Registration() {
    ...
    return (
        <div className="w-full h-screen items-center justify-center flex bg-gray-900 font-['Open-Sans']">
            <img src="https://images.unsplash.com/photo-1504674900247-0877df9cc836?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80" alt="no-img" className='w-full h-full brightness-50' />
